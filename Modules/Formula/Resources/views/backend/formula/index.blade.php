                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("formula::text.product")
                            </th>
                            <th>
                                @lang("formula::text.version")
                            </th>
                            <th>
                                @lang("formula::text.data")
                            </th>
                            <th>
                                @lang("formula::text.ingredients")
                            </th>
                            <th class="text-end">
                                @lang("formula::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{ $module_name_singular->numero }}
                            </td>
                            <td>
                                <a href="{{ url("admin/$module_name", $module_name_singular->numero) }}">{{ $module_name_singular->prodotto }}</a>
                            </td>
                            <td>
                                {{ $module_name_singular->versione }}
                            </td>
                            <td>
                                {{ $module_name_singular->data }}
                            </td>
                            <td>
                                {{ $module_name_singular->ingredienti }}
                            </td>
                            <td class="text-end">
