                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("ingrediente::text.nome")
                            </th>
                            <th>
                                @lang("ingrediente::text.updated_at")
                            </th>
                            <th>
                                @lang("ingrediente::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("ingrediente::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url("admin/$module_name", $module_name_singular->id) }}">{{ $module_name_singular->nome }}</a>
                            </td>
                            <td>
