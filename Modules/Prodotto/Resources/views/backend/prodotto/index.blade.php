                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("prodotto::text.name")
                            </th>
                            <th>
                                @lang("prodotto::text.updated_at")
                            </th>
                            <th class="text-end">
                                @lang("prodotto::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{ $module_name_singular->n_prodotto }}
                            </td>
                            <td>
                                <a href="{{ url("admin/$module_name", $module_name_singular->n_prodotto) }}">{{ $module_name_singular->prodotto }}</a>
                            </td>
                            <td>
