...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->modelForm($data, 'PATCH', route("backend.$module_name.update", $id_prodotto))->class('form')->acceptsFiles()->open() }}
                ...
                <div class="row">
                    ...
                    <div class="col-8 mt-4">
                        <div class="float-end">
                            ...
                            <a href='{{route("backend.$module_name.destroy", $id_prodotto)}}' class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('Delete')}}"><i class="fas fa-trash-alt"></i></a>
                            @endcan
