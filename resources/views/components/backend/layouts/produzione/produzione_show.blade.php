@props(["data"=>"", "module_name", "module_path", "module_title"=>"", "module_icon"=>"", "module_action"=>"", "id_produzione"=>""])
<div class="card">
    @if ($slot != "")
    <div class="card-body">
        {{ $slot }}
    ...
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col-12">
                ...
                <x-backend.produzione.section-show-table :data="$data" :module_name="$module_name" />
